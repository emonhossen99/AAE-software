                        ...
                        <div class="col-md-10 mx-auto grid-margin stretch-card">
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <form class="forms-sample" action="{{url('/category')}}" method="POST">
                                        @csrf
                                        <div class="form-group">
                                            <label for="exampleInputUsername1">Main Category Name</label>
                                            <input type="text" name="main_category" class="form-control" id="exampleInputUsername1" placeholder="Enter Main Category Name" />
                                        </div>
                                            ...
                                            <tbody>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        ...
                                                        <a href="{{url('category/'.$data->id.'/edit')}}"><button type="button" class="btn btn-info editButton">Edit</button></a>
                                                        <br>
