                        ...
                        <div class="col-md-6 mx-auto grid-margin stretch-card">
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <form class="forms-sample" action="{{ route('subcats.update', $cat_data[0]->id) }}" method="POST">
                                        @csrf
                                        @method('PUT')
                                        <div class="form-group">
                                            <label for="exampleInputUsername1">Update Sub Category Name</label>
                                            <input type="text" class="form-control" id="exampleInputUsername1" name="update_cat" value="{{$cat_data[0]->sub_cat_name}}" />
                                            <input type="hidden" class="form-control" id="exampleInputUsername1" name="update_id" value="{{$cat_data[0]->cat_id}}" />
                                        </div>
